...
def analyze_and_display(df, filename):
    ...
    # 定义整数列的显示格式（{:.0f} 表示不保留小数）
    # 如果希望显示千分位（如 1,000），可以使用 "{:,.0f}"
...
if uploaded_files:
    ...
    # 🔥🔥 关键修复：只有当 processed_dfs 不为空时，才执行后续的图表绘制和Excel导出 🔥🔥
    if processed_dfs:
        # ==============================================================================
        # 🔥🔥 进阶功能：全景对比 & 环比分析 🔥🔥
        # ==============================================================================
        ...
        # 如果 processed_dfs 为空，说明所有文件都处理失败了
